...
export function renderInstagramCarouselV3Preview(payload: OfficialPublicPayloadV24, city: CityConfig, options: { embedded?: boolean; studioPrimary?: boolean } = {}): string {
  if (!payload.analysis) {
