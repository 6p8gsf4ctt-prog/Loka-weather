...
ok(watchCardRenderer.includes("drawImageCentered(mainIcon") && watchCardRenderer.includes("drawImageCentered(icon") && watchCardRenderer.includes("const x=74,y=704") && watchCardRenderer.includes("card.weekdayLabel+'. '+card.dayLabel"), "overview_draws_watch_card_with_official_loka_pictograms");
