...
ok(WEEKLY_COMPLEMENTARY_BOX_LAYOUT.content.y === 336 && WEEKLY_COMPLEMENTARY_BOX_LAYOUT.editorial.y > WEEKLY_COMPLEMENTARY_BOX_LAYOUT.content.y && WEEKLY_COMPLEMENTARY_BOX_LAYOUT.editorial.bottom === LOKA_DAILY_FEED_FRAME.lowerBox.bottom, "contextual_boxes_keep_the_daily_lower_baseline");
ok(complementaryRenderer.includes("drawWeeklySharedFrame(canvas,background,logo,content)") && complementaryRenderer.includes("box(x,contentBox.y,w,contentBox.height)") && complementaryRenderer.includes("box(x,editorial.y,w,editorial.height)") && complementaryRenderer.includes("drawSlide1FeedSignature()") && complementaryContentRenderer.includes("visual.headline") && complementaryContentRenderer.includes("visual.comparison") && complementaryEditorialRenderer.includes("visual.editorialLine"), "slides2_to_4_use_two_content_boxes_inside_one_shared_frame");
