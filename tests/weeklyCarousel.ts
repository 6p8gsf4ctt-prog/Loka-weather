...
ok(WEEKLY_COMPLEMENTARY_BOX_LAYOUT.content.y === 336 && WEEKLY_COMPLEMENTARY_BOX_LAYOUT.content.bottom === 1069 && WEEKLY_COMPLEMENTARY_BOX_LAYOUT.editorial.y === 1095 && WEEKLY_COMPLEMENTARY_BOX_LAYOUT.editorial.height === 210 && WEEKLY_COMPLEMENTARY_BOX_LAYOUT.editorial.bottom === LOKA_DAILY_FEED_FRAME.lowerBox.bottom, "contextual_three_box_geometry_is_locked_to_daily_lower_baseline");
ok(complementaryRenderer.includes("drawWeeklySharedFrame(canvas,background,logo,content)") && complementaryRenderer.includes("box(x,contentBox.y,w,contentBox.height)") && complementaryRenderer.includes("box(x,editorial.y,w,editorial.height)") && !complementaryRenderer.includes("secondary.y") && complementaryRenderer.includes("drawSlide1FeedSignature()") && complementaryContentRenderer.includes("visual.headline") && complementaryContentRenderer.includes("visual.comparison") && complementaryContentRenderer.includes("y+438") && complementaryContentRenderer.includes("y+560") && comparisonRenderer.includes("fittedSize(item.value,390,53,38,760)") && complementaryEditorialRenderer.includes("visual.editorialLine"), "slides2_to_4_use_locked_title_information_and_editorial_boxes");
