...
ok(EDITORIAL_EXPORT_SCHEMA_VERSION === "1.1", "export_schema_1_1");
...
ok(enhanced.includes("version:'1.1'"), "ui_export_version_1_1");
...
console.log(`EDITORIAL_EXPORT_STEP6 ${passed}/12 PASS`);
