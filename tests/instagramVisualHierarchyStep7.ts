...
ok(renderStory.includes("drawFeedGeneral(mainIcon)"), "story_reuses_publication_general_group_contract");
...
ok(renderStory.includes("drawFeedComments()"), "story_reuses_publication_summary_contract");
