...
ok(editorial.slide1.synthesis.text.endsWith(".") && editorial.slide1.synthesis.text.length <= 100 && editorial.slide1.synthesis.maximumLines === 2, "slide1_synthesis_is_a_short_bounded_single_sentence");
ok(!/conseil|privilégier|surveiller|globalement|progressivement/i.test(editorial.slide1.synthesis.text), "slide1_synthesis_describes_the_week_without_advice_or_generic_filler");
