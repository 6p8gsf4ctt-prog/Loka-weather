...
Le moteur ne reconstruit pas le langage quotidien. Il réemploie le logo, les
mesures d’en-tête, le lettrage espacé de la ville, la police Canvas, le pied de
page et la signature existants. La donnée nouvelle transmise au cadre est la
période dynamique, au format `LUNDI 7 AU DIMANCHE 13 SEPTEMBRE`, ainsi que la
